...
public:
  ...
  void setupDefaultJointConfigs()
  {
    ...
    // BL (can1)
    joint_configs_[0] = {"BL_collar_joint", "can1", 4,  1, -0.3994, -0.40,  0.40, 20.0, 17.0, {}};
    joint_configs_[1] = {"BL_hip_joint",    "can1", 5, -1, -4.9934, -3.14,  3.14, 20.0, 17.0, {}};
    joint_configs_[2] = {"BL_knee_joint",   "can1", 6, -1, -0.0313, -0.10,  2.80, 20.0, 17.0, {}};

    // BR (can0)
    joint_configs_[3] = {"BR_collar_joint", "can0", 4,  1,  0.1206, -0.40,  0.40, 20.0, 17.0, {}};
    joint_configs_[4] = {"BR_hip_joint",    "can0", 5,  1,  1.3447, -3.14,  3.14, 20.0, 17.0, {}};
    joint_configs_[5] = {"BR_knee_joint",   "can0", 6,  1, -0.0186, -0.10,  2.80, 20.0, 17.0, {}};

    // FL (can1)
    joint_configs_[6] = {"FL_collar_joint", "can1", 1, -1, -0.3469, -0.40,  0.40, 20.0, 17.0, {}};
    joint_configs_[7] = {"FL_hip_joint",    "can1", 2, -1,  1.2389, -3.14,  3.14, 20.0, 17.0, {}};
    joint_configs_[8] = {"FL_knee_joint",   "can1", 3, -1, -0.0174, -0.10,  2.80, 20.0, 17.0, {}};

    // FR (can0)
    joint_configs_[9] = {"FR_collar_joint", "can0", 1, -1,  1.6822, -0.40,  0.40, 20.0, 17.0, {}};
    joint_configs_[10] ={"FR_hip_joint",    "can0", 2,  1,  1.1756, -3.14,  3.14, 20.0, 17.0, {}};
    joint_configs_[11] ={"FR_knee_joint",   "can0", 3,  1, -0.1321, -0.10,  2.80, 20.0, 17.0, {}};
