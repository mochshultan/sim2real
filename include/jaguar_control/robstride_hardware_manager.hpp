...
public:
  ...
  void setupDefaultJointConfigs()
  {
    ...
    // BL (can1)
    joint_configs_[0] = {"BL_collar_joint", "can1", 4,  1, -0.3245, -0.40,  0.40, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[1] = {"BL_hip_joint",    "can1", 5, -1, +1.3483, -3.14,  3.14, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[2] = {"BL_knee_joint",   "can1", 6, -1, +0.0488, -0.10,  2.80, 20.0, RS00_TORQUE_LIMIT_NM, {}};

    // BR (can0)
    joint_configs_[3] = {"BR_collar_joint", "can0", 4,  1, +0.3017, -0.40,  0.40, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[4] = {"BR_hip_joint",    "can0", 5,  1, +1.3476, -3.14,  3.14, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[5] = {"BR_knee_joint",   "can0", 6,  1, +0.0039, -0.10,  2.80, 20.0, RS00_TORQUE_LIMIT_NM, {}};

    // FL (can1)
    joint_configs_[6] = {"FL_collar_joint", "can1", 1, -1, -0.3826, -0.40,  0.40, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[7] = {"FL_hip_joint",    "can1", 2, -1, +1.2127, -3.14,  3.14, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[8] = {"FL_knee_joint",   "can1", 3, -1, +0.0967, -0.10,  2.80, 20.0, RS00_TORQUE_LIMIT_NM, {}};

    // FR (can0)
    joint_configs_[9] = {"FR_collar_joint", "can0", 1, -1, +0.3281, -0.40,  0.40, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[10] ={"FR_hip_joint",    "can0", 2,  1, +1.1767, -3.14,  3.14, 20.0, RS00_TORQUE_LIMIT_NM, {}};
    joint_configs_[11] ={"FR_knee_joint",   "can0", 3,  1, +0.0927, -0.10,  2.80, 20.0, RS00_TORQUE_LIMIT_NM, {}};
