...
class SitZeroCalibrator:
    def __init__(self):
        ...
        self.kp = float(P.KP_GAIN[1])          # Stiffness for sit holding & tuning (Hip/Knee)
    ...
    def print_final_offsets(self):
        ...
        print("```cpp")
        print(f'joint_configs_[0] = {{"BL_collar_joint", "can1", 4,  1, {cpp_offsets[0]:+7.4f}, -0.40,  0.40, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[1] = {{"BL_hip_joint",    "can1", 5, -1, {cpp_offsets[1]:+7.4f}, -3.14,  3.14, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[2] = {{"BL_knee_joint",   "can1", 6, -1, {cpp_offsets[2]:+7.4f}, -0.10,  2.80, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[3] = {{"BR_collar_joint", "can0", 4,  1, {cpp_offsets[3]:+7.4f}, -0.40,  0.40, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[4] = {{"BR_hip_joint",    "can0", 5,  1, {cpp_offsets[4]:+7.4f}, -3.14,  3.14, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[5] = {{"BR_knee_joint",   "can0", 6,  1, {cpp_offsets[5]:+7.4f}, -0.10,  2.80, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[6] = {{"FL_collar_joint", "can1", 1, -1, {cpp_offsets[6]:+7.4f}, -0.40,  0.40, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[7] = {{"FL_hip_joint",    "can1", 2, -1, {cpp_offsets[7]:+7.4f}, -3.14,  3.14, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[8] = {{"FL_knee_joint",   "can1", 3, -1, {cpp_offsets[8]:+7.4f}, -0.10,  2.80, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[9] = {{"FR_collar_joint", "can0", 1, -1, {cpp_offsets[9]:+7.4f}, -0.40,  0.40, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[10] ={{"FR_hip_joint",    "can0", 2,  1, {cpp_offsets[10]:+7.4f}, -3.14,  3.14, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print(f'joint_configs_[11] ={{"FR_knee_joint",   "can0", 3,  1, {cpp_offsets[11]:+7.4f}, -0.10,  2.80, 20.0, RS00_CONTROL_TORQUE_LIMIT_NM, {{}}}};')
        print("```")
        print("=" * 80 + "\r\n")
