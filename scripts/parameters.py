...
MOTOR_OFFSET_ANGLE = [
    +0.3245, -1.3483, -0.1288,  # BL (can1: Collar, Hip, Knee)
    -0.3017, -1.3476, -0.1339,  # BR (can0: Collar, Hip, Knee)
    +0.3426, -1.2127, -0.0367,  # FL (can1: Collar, Hip, Knee)
    -0.1981, -1.1767, -0.1427,  # FR (can0: Collar, Hip, Knee)
]
